...
# err_list <- lapply(seq_len(times), function(i){
  ...
  fit_sir <- ssdr.cv(train_x, train_y, lam1_fac = seq(1.5,0.8, length.out = 10), lam2_fac = seq(0.001,0.2, length.out = 10),
  ...
  # gamma = c(1,2), nfolds = 3, plot = TRUE, type = 'sir', pmax=400)
  # fit_sir <- ssdr.cv(train_x, train_y, lam1_fac = seq(2,1.2, length.out = 10), lam2_fac = seq(0.001,0.2, length.out = 10),
  #                    gamma = c(1,2), nfolds = 3, type = 'sir', pmax=400)
  ...
  fit_intra <- ssdr.cv(train_x, train_y, lam1_fac = seq(1.5,0.8, length.out = 10), lam2_fac = seq(0.001,0.2, length.out = 10),
  ...
  fit_pfc <- ssdr.cv(train_x, train_y, lam1_fac = seq(1.5,0.5, length.out = 10), lam2_fac = seq(0.001,0.2, length.out = 10),
