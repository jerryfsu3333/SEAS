...
data <- read.csv("~/Dropbox/projects/seas_code/data/riboflavinv100.csv")
...
# err_list <- lapply(seq_len(times), function(i){
  ...
  # fit_sir <- ssdr.cv(train_x, train_y, lam1_fac = seq(2,0.3, length.out = 10), lam2_fac = seq(0.1,4, length.out = 10),
  ...
  # fit_intra <- ssdr.cv(train_x, train_y, lam1_fac = seq(2,0.3, length.out = 10), lam2_fac = seq(0.1,2, length.out = 10),
  ...
  # fit_pfc <- ssdr.cv(train_x, train_y, lam1_fac = seq(1.5,0.3, length.out = 10), lam2_fac = seq(0.1,2, length.out = 10),
